/*! console-nav.js v3 — 常驻头部 · 当前 tab 常显 · 鼠标划过时其他 tab 交错展开 */
(function(){
  ...
  function build(){
    ...
    // 排序:active 居中,其他左右分列 (交错 delay 从中心向两边扩散)
    ...
    var t;
    function open(){clearTimeout(t);shell.classList.add('on')}
    ...
    // touch: tap active tab to expand
